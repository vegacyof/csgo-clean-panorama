...
A modified CSGO panorama with all irrelevant and non-functional features removed from the interface and the Danger Zone unlocked.

## Installation

1. Download `panorama.dll` and `code.pbin` from the Releases page.
